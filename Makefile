...
ifeq ($(SGX_DEBUG), 1)
        SGX_COMMON_FLAGS += -O0 -g -w
else
        SGX_COMMON_FLAGS += -O2 -w
endif
...
Enclave_Include_Paths := -IEnclave -I$(SGX_SDK)/include -I$(SGX_SDK)/include/libcxx -I$(SGX_SDK)/include/tlibc -IEnclave/Libsodium/include -IEnclave/Libsodium/include/sodium -I/usr/lib/gcc/x86_64-linux-gnu/5/include
